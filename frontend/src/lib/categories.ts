...
export const DEFAULT_INCOME_CATEGORIES: DefaultCategory[] = [
  {
    ...
    color: '#10B981',
    children: [
      { name: '基本工资', icon: 'Banknote', color: '#10B981' },
      { name: '奖金', icon: 'Gift', color: '#34D399' },
      { name: '加班费', icon: 'Clock', color: '#059669' },
    ],
  },
  {
    name: '经营收入',
    ...
    color: '#047857',
    children: [
      { name: '销售收入', icon: 'ShoppingCart', color: '#047857' },
      { name: '服务收入', icon: 'Handshake', color: '#065F46' },
    ],
  },
  {
    name: '投资收益',
    ...
    color: '#064E3B',
    children: [
      { name: '利息', icon: 'Percent', color: '#064E3B' },
      { name: '股息', icon: 'TrendingUp', color: '#022C22' },
      { name: '基金收益', icon: 'ChartLine', color: '#065F46' },
    ],
  },
  {
    name: '其他收入',
    ...
    color: '#059669',
    children: [
      { name: '退款', icon: 'RotateCcw', color: '#059669' },
      { name: '红包', icon: 'Gift', color: '#34D399' },
      { name: '其他', icon: 'Plus', color: '#047857' },
    ],
  },
];
