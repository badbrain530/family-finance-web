...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-48 overflow-hidden rounded-lg border border-border bg-surface p-1 shadow-dropdown',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'text-text-primary focus:bg-primary-50 focus:text-primary-600',
